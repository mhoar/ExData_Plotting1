...
png(file = "myplot.png")
with(epc.data, ts.plot(tstime, Sub_metering_1, Sub_metering_2, Sub_metering_3, gpars=list(xaxt='n', ann=FALSE, type="l", col=c("black", "red", "blue"))))
axis(1, labels=c("Thu", "Fri", "Sat"), at=c(0, 1440, 2880), cex.axis=.9)
title(main="", ylab="Energy Sub Metering")
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex=.9, col=c("black", "red", "blue"), lty=1)
dev.off()
